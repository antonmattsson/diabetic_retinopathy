...
train_gen = datagen.flow_from_directory('../data/grayscale_aug_train',
                                        target_size=(256, 256),
                                        batch_size=batch_size)

test_datagen = ImageDataGenerator(rescale=1./255)

test_gen = test_datagen.flow_from_directory('../data/grayscale_aug_validation',
                                        target_size=(256, 256),
                                        batch_size=batch_size)

# Check if a pretrained model exists
model_path = "model_grayscale_augmented_fast.h5"
...
for i in range(n_epochs):
    ...
    model.save('model_grayscale_augmented_fast.h5')
    with open('history_grayscale_augmented_fast', 'wb') as file_pi:
